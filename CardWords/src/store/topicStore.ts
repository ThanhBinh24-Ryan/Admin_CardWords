...
//   bulkCreateTopics: async (topicsData) => {
//     set({ loading: true, error: null });
//     try {
//       const response = await topicService.bulkCreateTopics({ topics: topicsData });
...
//   bulkUpdateTopics: async (topicsData) => {
//     set({ loading: true, error: null });
//     try {
//       const response = await topicService.bulkUpdateTopics({ topics: topicsData });
